...
You can expect to have three assigned readings for each thematic section (these are marked as readings underneat the section headings - weekly resources are not mandatory but are pretty rad.) You must complete all readings prior to class, and come ready to participate in discussion. Details for how to submit assignments will be given in class.
...
1. All Data Are Local (Yanni Loukissas) - PICK A CHAPTER HERE
...
Class 10 - 4/8/19 - Data Liberation
------------
